...
class Books
{
    ...
    public function readById()
    {
        try {
            // On écrit la requête
            $query = $this->connexion->prepare("SELECT b.id, b.title, b.author_id, a.name as author, b.editor, b.summary, b.release_date, b.cover, c.name as categories_name FROM " . $this->table . " b 
                                            LEFT JOIN categories c ON b.category_id = c.id 
